...
CPlayTaskQueue::CPlayTaskQueue(QWidget *parent) : QWidget(parent)
{
    // 设置固定宽度
    setFixedWidth(300);
        setStyleSheet("background-color: rgb(255, 251, 235); color: black; font-family: 'SimSun', '黑体';");
    ...
    (
        ...
        "QListWidget::item { padding: 8px; border-bottom: 1px solid #DBDBDB; color: black; font-family: 'SimSun', '黑体'; }"
        "QListWidget::item:selected { background-color: #FFF8DC; }"
        "QListWidget::item:hover { background-color: #F0ECDC; }"
    );
