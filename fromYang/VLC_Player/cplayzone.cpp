...
CPlayZone::CPlayZone(QWidget *parent) : QWidget(parent)
{
    ...
    m_central_play_button->setStyleSheet(
        "QPushButton {border-radius: 10px; background-color: rgba(0, 0, 0, 0.8); padding: 5px; border: none;}"
        "QPushButton:hover {background-color: rgba(0, 0, 0, 1.0);}"
...
//    contentLayout->addWidget(line);
    ...
    textLabel->setStyleSheet("color: white; font-family: 'SimSun', '黑体'; font-size: 18px;");
...
void CPlayZone::mouseDoubleClickEvent(QMouseEvent *event)
{
