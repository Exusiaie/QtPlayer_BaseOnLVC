...
#include <memory>
#include "../../VLC_Player/ctitlebar.h"
...
QT_MOC_LITERAL(3, 20, 21), // "playlistButtonClicked"
QT_MOC_LITERAL(4, 42, 13), // "doubleClicked"
QT_MOC_LITERAL(5, 56, 13) // "onClickedSlot"

    },
    "CTitleBar\0sigClose\0\0playlistButtonClicked\0"
    "doubleClicked\0onClickedSlot"
};
...
void CTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->playlistButtonClicked(); break;
        case 2: _t->doubleClicked(); break;
        case 3: _t->onClickedSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTitleBar::sigClose)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CTitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTitleBar::playlistButtonClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CTitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTitleBar::doubleClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void CTitleBar::playlistButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void CTitleBar::doubleClicked()
{
