...
#include <memory>
#include "../../MyPlayer/CVolumeButton.h"
...
QT_MOC_LITERAL(1, 14, 18), // "sliderValueChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 5) // "value"

    },
    "CVolumeButton\0sliderValueChanged\0\0"
    "value"
};
...
void CVolumeButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CVolumeButton::sliderValueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CVolumeButton::sliderValueChanged(int _t1)
{
