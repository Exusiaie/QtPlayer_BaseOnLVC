...
#include <memory>
#include "../../MyPlayer/CMainWindow.h"
...
QT_MOC_LITERAL(3, 18, 9) // "closeSlot"

    },
    "CMainWindow\0open\0\0closeSlot"
};
...
void CMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CMainWindow::open)) {
                *result = 0;
                return;
            }
        }
