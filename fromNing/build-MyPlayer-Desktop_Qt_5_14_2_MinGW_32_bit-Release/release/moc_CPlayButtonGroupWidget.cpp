...
#include <memory>
#include "../../MyPlayer/CPlayButtonGroupWidget.h"
...
QT_MOC_LITERAL(1, 23, 8), // "sig_stop"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 7), // "sig_pre"
QT_MOC_LITERAL(4, 41, 8), // "sig_play"
QT_MOC_LITERAL(5, 50, 8), // "sig_next"
QT_MOC_LITERAL(6, 59, 18), // "sliderValueChanged"
QT_MOC_LITERAL(7, 78, 5), // "value"
QT_MOC_LITERAL(8, 84, 10), // "setPlaying"
QT_MOC_LITERAL(9, 95, 7) // "playing"

    },
    "CPlayButtonGroupWidget\0sig_stop\0\0"
    "sig_pre\0sig_play\0sig_next\0sliderValueChanged\0"
    "value\0setPlaying\0playing"
};
...
void CPlayButtonGroupWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_stop(); break;
        case 1: _t->sig_pre(); break;
        case 2: _t->sig_play(); break;
        case 3: _t->sig_next(); break;
        case 4: _t->sliderValueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->setPlaying((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CPlayButtonGroupWidget::sliderValueChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void CPlayButtonGroupWidget::sliderValueChanged(int _t1)
{
